...
//		int indexof(문자열 ) : 문자열의 시작번지를 반환 없으면 -1
		System.out.println(str+"에서 world 의 시작번지는?"+ str.indexOf("world"));
...
//		String substring(시작번지, 끝번지 ) : 시작번지부터 끝번지 전까지 부분 문자열을 추출  
		System.out.println(str+"에서 6번지부터 부분문자열 "+str.substring(6));
		System.out.println(str+"에서 6번지부터 10번지 전까지 부분문자열 "+str.substring(6,10));
		
//		String toLowerCase() : 소문자로
//		String toUpperCase() : 소문자로
